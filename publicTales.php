...
?>
	...
	$sql = "SELECT * FROM zapis order by id desc";
	$result = $conn->query($sql);
	...
	<div class="zapis-container">
		<div class="zapis-header">
			...
			<form class="srck" action="includi/addFavorite.inc.php?id=<?php echo $row['id'] ?>&page=1" method="post">
		...
		<div class="zapis-footer">
			...
			<div class="z-f-upDown">
				...
				<form class="rate-down" action="includi/oceniZapis.inc.php?id=<?php echo $row['id']?>&page=1" method="post">
	...
	echo '<h4 style="margin-top:3%;">V bazi še ni nobenega zapisa :(</h4>';
	}
	?>
</div>
</div>
...
$('.nav-icons').children(":eq(0)").addClass("bgWhite");
